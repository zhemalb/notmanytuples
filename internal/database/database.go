...
func OpenDataBase(logger *zap.Logger, dsn string) (*DataBase, error) {
	...
	err = db.AutoMigrate(&models.User{}, &models.Pipeline{}, &models.Session{}, &models.Flag{}, &models.OverriddenScore{}, &models.BenchmarkResult{}, &models.SubmissionBan{}, &models.SubmissionModerationEvent{})
	if err != nil {
		return nil, err
	}
